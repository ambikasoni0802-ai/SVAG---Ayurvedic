...
st.markdown(
    ...
    .st-key-plus_btn button [data-testid="stIconMaterial"] {
        display: none;
    }
    .st-key-plus_btn button {
    ...
    .st-key-mic_btn button [data-testid="stIconMaterial"] {
        display: none;
    }
    ...
    .st-key-voice_assistant_btn button [data-testid="stIconMaterial"] {
        display: none;
    }
    .st-key-voice_assistant_btn button {
    ...
    .st-key-imagegen_btn button [data-testid="stIconMaterial"] {
        display: none;
    }
    .st-key-imagegen_btn button {
