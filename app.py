...
GOOGLE_G_SVG = """<svg width="20" height="20" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
...
GOOGLE_G_B64 = base64.b64encode(GOOGLE_G_SVG.encode()).decode()
    ...
    with lcol_b:
        st.markdown(
            ...
            <div style="text-align:center; margin-bottom:8px;">
                <img src="data:image/svg+xml;base64,{GOOGLE_G_B64}" width="20"
                     style="vertical-align:middle; margin-right:8px;">
                <span style="vertical-align:middle; font-weight:500;">Sign in with Google</span>
            </div>
            """,
